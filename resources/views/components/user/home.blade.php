        ...
        <div class="w-full lg:w-1/2 flex items-end p-3" data-aos="fade-right">
            <div class="space-y-6 text-center lg:text-start">
                ...
                <p class="text-slate-300">
                    Tempor rebum no at doebum no at dolore lorem clita rebum rebum rebum stet dolor sed justo kasd. Ut dolor sed magna dolor sea diam. Sit diam sit justo amet ipsum vero ipsum clita lorem
                </p>
